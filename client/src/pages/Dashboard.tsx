...
const LESSONS_DEF = [
  ...
  { id: "4", title: "High and Low", emoji: "📏", color: "#4AABF5", duration: "6 min", defaultStars: 0, tags: ["slow", "theory"] },
  { id: "5", title: "Meet the Piano", emoji: "🎹", color: "#FFB800", duration: "5 min", defaultStars: 0, tags: ["slow", "theory"] },
