...
const LESSON_FUN_FACTS: Record<string, string> = {
  ...
  "4": "The lowest note on a piano vibrates only 27 times per second, but the highest vibrates over 4,000!",
  "5": "The piano has 88 keys, but just 5 special notes can play thousands of melodies!",
